// -----------------------------------------------------------------------------
/*
  This program is for module integration testing:
  + I2C: DS3231 Clock
  + I2C: 1602 LCD
  + I2C: PCF8574 module for switch inputs
  + SPI: SD card module

  There I2C components work well together: Clock, LCD, and the PCF8574 module.
    Sketch uses 18184 bytes (59%) of 30720 bytes.
    Global variables use 1187 bytes (57%) of 2048 bytes.

  Connect components: Clock, LCD, and PCF8574 to the Nano:
