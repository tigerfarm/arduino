...
import static asm.asmUpload.getBaudSleepTimeCr;
...
import static asm.asmUpload.setBaudSleepTimeCr;
...
public class asm {
    ...
    private static final String ASMVERSION = "0.96b";
            ...
            switch (cmd) {
                ...
                case "set":
                    switch (cmdP1) {
                        ...
                        case "baudcr":
                            if (cmdP2.length() == 0) {
                                System.out.println("+ Upload baud rate CR/LF sleep time set to: " + getBaudSleepTimeCr() + ".");
                            } else {
                                setBaudSleepTimeCr(Integer.parseInt(cmdP2));
                                System.out.println("+ Set upload baud rate CR/LF sleep time to: " + cmdP2);
                            }
                            break;
                        case "debug":
                            if (cmdP2.length() == 0) {
                ...
                case "help":
                    ...
                    System.out.println("++ Serial port baud rate CR : " + getBaudSleepTimeCr());
                    ...
                    System.out.println("+ set baudst <sleep time>   : Set baud rate sleep time for uploading.");
                    System.out.println("+ set baudcr                : List baud rate sleep time after sending a CR.");
                    System.out.println("+ set baudcr <sleep time>   : Set baud rate sleep time after sending a CR.");
                    System.out.println("----------------------");
