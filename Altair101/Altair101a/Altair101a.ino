...
void processWaitSwitch(byte readByte) {
  ...
  switch (readByte) {
    ...
    case 'H':
      ...
      break;
    case 'I':
      // RemovePlayer playerSwitch('i');
      break;
    case 'g':
      // RemovePlayer playerSwitch('s');
      break;
    case 'G':
      // RemovePlayer playerSwitch('r');
      break;
    case 'k':
      // RemovePlayer playerSwitch('v');
      Serial.print(F("> "));
      break;
    case 'K':
      // RemovePlayer playerSwitch('V');
