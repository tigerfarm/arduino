...
/*
  ...
  Connect to Nano where the Nano is the master and the SD card module is the slave:
    CS (chip/slave select)       to Nano pin 10 (SS pin). Can be any digital pin on the master(Nano) to enable and disable specific devices on the SPI bus.
